...
class BetterGeometries(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        alg_params = {
            ...
            'TOLERANCE': 0.005,
            'OUTPUT': 'memory: Snapped_aerialboxes'  #############################################
        }
        ...
        #Snapped_aerialboxes = context.takeResultLayer(outputs['SnapAerialboxToPaal']["OUTPUT"]) #############################################
        ...
        #Snapped_dducts = context.takeResultLayer(outputs['SnapDductToAerialBoxes']["OUTPUT"])  #############################################
        ...
        #Snapped_dcables = context.takeResultLayer(outputs['SnapfxDcableToDp']["OUTPUT"])  #############################################
        ...
        #Snapped_fcables = context.takeResultLayer(outputs['SnapFxFcableToCo']["OUTPUT"])  #############################################
        ...
        alg_params = {
            ...
            'TOLERANCE': 0.005,
            'OUTPUT': 'memory: Snapped_dropcables'  #############################################
        }
        ...
        #Snapped_dropcables = context.takeResultLayer(outputs['SnapFxdropcableToHp']["OUTPUT"])  #############################################
        #print(results)  #debug      

        return results
        """return {
            ['Snapped_aerialboxes']: Snapped_aerialboxes,
            ['Snapped_dducts']: Snapped_dducts,
            ['Snapped_dcables']: Snapped_dcables,
            ['Snapped_fcables']: Snapped_fcables,
            ['Snapped_dropcables']: Snapped_dropcables
        }"""

    def name(self):
        return 'Better Geometries - test'
