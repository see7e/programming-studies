...
The advantage is that Linked List don't use consecutive slots of memory, making them easier to maniplulate. They're faster, and the nodes can have multiple types of elemnts.
